        ...
        <nav class="nav">
            <div class="dropdown">
                <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    <span class="logged-name">Jane<span class="hidden-md-down">{{\Illuminate\Support\Facades\Auth::user()->name}}</span></span>
                    <img src="{{asset(\Illuminate\Support\Facades\Auth::user()->image)}}" class="wd-32 rounded-circle" alt="">
                </a>
