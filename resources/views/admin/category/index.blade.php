                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('category.delete',$item->id) }}" method="POST">
                                                    @csrf
                                                    <button href="{{route('category.delete',$item->id)}}" class="btn btn-danger btn-sm" id="delete" title="Delete"><i class="fa fa-trash"></i> </button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <div class="card-body">
                            <form action="{{ route('category-store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="category_name_en" value="{{ old('category_name_en') }}" placeholder="Enter category_name_bn">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="category_name_bn" value="{{ old('category_name_bn') }}" placeholder="Enter category_name_bn">
